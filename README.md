...
| `43_ai_fif2_bot.py` | AI FIF2 Mirror | Vol-gated ladder mirror of fresh fleet signals (T-110/T-111 evidence chain) — `CH_FIF2` → `CH_FIF1` → `CH_NEW_IDEAS` (not Cornix-executed; fills come from the trailing roster seat via bot 40 → `CH_TRAILING`), gated by `FIF2_LIVE_POSTING` |
