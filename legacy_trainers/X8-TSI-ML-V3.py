...
# ---------------- CONFIG ----------------
FILE_NAME = "tsi_signals_uniform.csv" # NEW FILE
MODEL_LONG = "model_tsi_long_uniform.pkl"
MODEL_SHORT = "model_tsi_short_uniform.pkl"

# --- OPTIMAL THRESHOLDS SET HERE ---
# Adjusted after the first run based on results
OPTIMAL_THRESHOLD_LONG = 0.75
OPTIMAL_THRESHOLD_SHORT = 0.70 # placeholder, will be re-selected
# ----------------------------------------
...
# ---------------- CALCULATE separate scale_pos_weight ----------------
...
# ---------------- TRAINING LONG MODEL ----------------
print("\nTraining LONG model (uniform targets, scaled weights)...")
...
print("Training SHORT model (uniform targets, scaled weights)...")
...
# ---------------- FINAL, OPTIMISED COMBINED STRATEGY ----------------
...
if len(optimized_trades) > 0:
    ...
    print("\nOptimised trades saved to 'tsi_optimized_filtered_trades_uniform.csv'")
else:
    print("No trades found at the selected optimal thresholds.")
