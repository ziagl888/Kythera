...
7. **PR** (Englisch, conventional commits — ziagl888-Repo, kein Org-Titel-Format), Kern-Reviews (z-code-reviewer + z-spec-compliance-review), Merge nach PASS.
